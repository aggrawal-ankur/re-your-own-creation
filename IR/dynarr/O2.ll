...
8:                                                ; preds = %4
  ...
  %13 = load i64, ptr %12, align 8, !tbaa !5    ; cap
  %14 = icmp ugt i64 %11, %13       ; count+1 > cap
...
31:                                               ; preds = %15, %28
  %32 = phi i64 [ %6, %15 ], [ %30, %28 ]    ; (elem_size)
  %33 = phi i64 [ %10, %15 ], [ %29, %28 ]   ; (count)
  %34 = phi ptr [ %16, %15 ], [ %26, %28 ]   ; (ptr)
  %35 = mul i64 %32, %33
...
define dso_local range(i32 -10, 1) i32 @bytecopy(ptr noundef readonly %0, ptr noundef %1) local_unnamed_addr #2 {
  %3 = icmp ne ptr %0, null       ; (!main)
  %4 = icmp ne ptr %1, null       ; (!copy)
  %5 = and i1 %3, %4
  br i1 %5, label %6, label %44

6:                                                ; preds = %2
  %7 = load ptr, ptr %0, align 8, !tbaa !11     ; (!main.ptr)
...
27:                                               ; preds = %23
  ...
  %29 = load i64, ptr %28, align 8, !tbaa !12       ; main.elem_size
  %30 = mul i64 %29, %24
...
33:                                               ; preds = %27
  ...
  %34 = load i64, ptr %19, align 8, !tbaa !13     ; main.count
  %35 = load ptr, ptr %1, align 8, !tbaa !11      ; copy.ptr
  %36 = load i64, ptr %13, align 8, !tbaa !13     ; copy.count
  br label %37

37:                                               ; preds = %17, %33
  %38 = phi i64 [ %18, %17 ], [ %36, %33 ]      ; copy.count
  %39 = phi ptr [ %10, %17 ], [ %35, %33 ]      ; copy.ptr
  %40 = phi i64 [ %20, %17 ], [ %34, %33 ]      ; main.count
  %41 = phi ptr [ %5, %17 ], [ %31, %33 ]       ; main.ptr
  %42 = getelementptr inbounds i8, ptr %0, i64 8
  %43 = load i64, ptr %42, align 8, !tbaa !12    ; main.elem_size
  %44 = mul i64 %43, %40
